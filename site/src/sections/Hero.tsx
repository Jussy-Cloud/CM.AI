...
import { HeroCosmicFlow } from "../components/ui/HeroCosmicFlow";
    ...
    <section className="min-h-screen grid grid-cols-1 lg:grid-cols-12 border-b border-ink/10 pt-24 bg-paper text-ink">
          ...
          <div className="relative">
            ...
            <AnimatePresence>
              {showContactMenu && (
                ...
                >
                  <a href="https://wa.me/27820000000" target="_blank" rel="noopener noreferrer" className="px-4 py-3 hover:bg-acid hover:text-ink rounded-xl transition-colors font-medium text-sm flex items-center gap-3">
      ...
      <div className="lg:col-span-5 relative hidden lg:block bg-ink overflow-hidden border-l border-ink/10">
        ...
        <motion.div
          ...
          className="absolute -inset-[50%] opacity-30 blur-[100px] z-0 pointer-events-none"
          style={{
